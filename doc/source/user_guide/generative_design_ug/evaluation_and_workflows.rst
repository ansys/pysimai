...
- **Parameter Importance**: how much each latent dimension contributes to the variability of the
  training data. Useful when working with a reduced latent space (see :ref:`reduced_latent_spaces_geomai`).
...
- You can retrieve the latent parameters of all training geometries with
  ...
  see :ref:`reduced_latent_spaces_geomai`.
...
convergence. See :ref:`reduced_latent_spaces_geomai` for how to retrieve reduced
